...
use ApiPayment\Controllers\CreateClient;
use Exception;
...
echo "Queue New Client - Total: $messageCount" . PHP_EOL;
...
$callback = function ($message) use ($messageCount, $channel) {
    $createClient = new CreateClient($message->body);
